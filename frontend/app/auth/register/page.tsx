  ...
  return (
    <main className="min-h-screen bg-[#050505] flex items-center justify-center p-4 relative overflow-hidden font-sans">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-[-10%] right-[-10%] w-[50%] h-[50%] bg-amber-500/10 rounded-full blur-[120px] animate-pulse" />
        <div className="absolute bottom-[-10%] left-[-10%] w-[50%] h-[50%] bg-blue-600/10 rounded-full blur-[120px] animate-pulse" style={{ animationDelay: '1.5s' }} />
          ...
          <div className="bg-[#0A0A0A]/80 backdrop-blur-3xl p-10 md:p-12 rounded-[2.5rem] shadow-2xl border border-white/5 relative overflow-hidden">
            ...
            <div className="text-center mb-10">
              <motion.div 
                initial={{ y: -20 }}
                animate={{ y: 0 }}
                className="w-16 h-16 bg-gradient-to-br from-amber-400 to-amber-600 rounded-2xl flex items-center justify-center text-black mx-auto mb-8 shadow-[0_0_30px_rgba(245,158,11,0.3)] relative group-hover:rotate-12 transition-transform duration-500"
              >
              ...
              <motion.div initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }} transition={{ delay: 0.3, duration: 0.6 }} className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-amber-100 to-rose-100 dark:from-amber-900/30 dark:to-rose-900/30 rounded-full border border-amber-200/50 dark:border-amber-700/50 mb-6">
                 ...
                 <span className="text-xs font-black uppercase tracking-widest text-amber-700 dark:text-amber-300">Exclusive Membership</span>
              </motion.div>
              
              <h1 className="text-3xl font-bold text-white tracking-tight mb-3">
                 <span className="bg-gradient-to-r from-amber-400 to-rose-400 bg-clip-text text-transparent">Join the Elite</span>
              </h1>
              <p className="text-zinc-500 text-sm font-medium uppercase tracking-[0.2em]">Create Your Luxury Profile</p>
            </div>
            ...
            <form onSubmit={handleRegister} className="space-y-4">
              <AnimatePresence mode="wait">
                {error && (
                  <motion.div 
                    ...
                    className="bg-red-500/10 border border-red-500/20 text-red-500 p-4 rounded-xl text-xs font-bold text-center mb-2"
                  >
                    {error}
                  </motion.div>
                )}
              ...
              <div className="space-y-1.5">
                <label className="text-[10px] font-bold uppercase text-zinc-500 ml-1 tracking-widest">Full Name</label>
              ...
              <div className="space-y-1.5">
                <label className="text-[10px] font-bold uppercase text-zinc-500 ml-1 tracking-widest">Password</label>
                <div className="relative">
            ...
            <div className="mt-10 pt-8 border-t border-white/5 flex flex-col items-center gap-4">
              <p className="text-zinc-500 font-bold text-[10px] uppercase tracking-widest">
                Already registered? {' '}
                <Link href="/auth/login" className="text-white hover:text-amber-500 transition-colors">
                  Login instead
                </Link>
              </p>
              ...
              <div className="flex items-center gap-2 text-[10px] font-bold text-zinc-600 uppercase tracking-widest">
                ...
                <span>Premium Hotels Await</span>
              </div>
            </div>
          </div>
        </div>
