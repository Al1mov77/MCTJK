        ...
        <div className="glass-premium p-10 md:p-12 rounded-[2.5rem] border-white/5 relative overflow-hidden shadow-2xl">
          ...
          <div className="text-center mb-12 space-y-4">
            ...
            <h1 className="text-4xl md:text-5xl font-bold tracking-tight uppercase italic leading-none text-white">
               Create <br/> <span className="text-[#d4af37]">Account</span>
            </h1>
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            <div className="space-y-2">
              <label className="text-[9px] font-bold uppercase text-cream/20 ml-1 tracking-[0.3em]">Identity</label>
              <div className="relative group">
                <User className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-cream/10 group-focus-within:text-[#d4af37] transition-colors" />
                <input 
                  type="text"
                  value={name}
            ...
            <div className="space-y-2">
              <label className="text-[9px] font-bold uppercase text-cream/20 ml-1 tracking-[0.3em]">Communication</label>
              <div className="relative group">
            ...
            <div className="space-y-2">
              <label className="text-[9px] font-bold uppercase text-cream/20 ml-1 tracking-[0.3em]">Secret Key</label>
              <div className="relative group">
            ...
            >
              {loading ? (
                ...
                <>
                  <span className="uppercase tracking-[0.2em] text-[10px] font-black">Begin Application</span>
          ...
          <div className="mt-12 pt-8 border-t border-white/5 text-center space-y-6">
            <p className="text-cream/20 font-bold text-[9px] uppercase tracking-[0.2em]">
              Established Subject? {' '}
              <Link href="/auth/login" className="text-[#d4af37] hover:text-white transition-colors">
                Return to Portal
              </Link>
            </p>
            
            <div className="flex items-center justify-center gap-3 text-[8px] font-bold text-white/10 uppercase tracking-[0.4em]">
               <div className="w-1 h-1 bg-[#d4af37]/40 rounded-full animate-pulse" />
               <span>Sovereign Membership Protocol</span>
            </div>
          </div>
        </div>
      </motion.div>
